...
export const Calculator50Usdt: React.FC = () => {
  ...
  // Compounding math: 50 * (1 + weeklyGain/100)^weeks
  const initialCap = 50;
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-emerald-950/80 via-slate-900 to-slate-900 border border-emerald-500/30 rounded-2xl p-5 shadow-xl">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-white">50 USDT Micro-Capital Economics</h2>
              <p className="text-xs text-slate-300">
                Transparent mathematics: Minimum order thresholds, realistic compounding, and fee friction.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2 text-xs font-mono bg-slate-950 px-3 py-1.5 rounded-xl border border-slate-800 text-emerald-300">
            <ShieldCheck className="w-4 h-4 text-emerald-400" />
            Zero-Scam Guarantee (Spot Only)
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-5 bg-slate-950 p-4 rounded-xl border border-slate-800 font-mono">
              <div>
                ...
                <div className="text-[10px] text-slate-400">from $50.00 initial</div>
              </div>
              <div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 flex flex-col justify-between shadow-lg">
          <div>
            <div className="flex items-center justify-between mb-4 border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-white">Fee Friction on 50 USDT</h3>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="font-mono font-bold text-amber-400">${orderSize} USDT</span>
                </div>
                <input
                  type="range"
                  min="5"
            ...
            <div className="grid grid-cols-2 gap-3 mt-5 bg-slate-950 p-4 rounded-xl border border-slate-800 font-mono">
              ...
              <div>
                <div className="text-[10px] text-slate-400 uppercase tracking-wider">Drag on $50 Capital</div>
          ...
          <p className="text-[11px] text-slate-400 mt-4 leading-relaxed bg-amber-950/30 p-2.5 rounded-lg border border-amber-800/50">
            ...
            <strong>Key Insight for 50 USDT:</strong> Do NOT use high-frequency scalping bots! A bot that trades 20 times a day will lose $12 in fees (24% of your entire 50 USDT!) to the exchange. Grid or DCA with wide spacing is required.
          </p>
        </div>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg">
        <h3 className="text-sm font-bold text-white mb-3 flex items-center gap-2">
          ...
          Why You Must NEVER Run 50 USDT on High Futures Leverage
        </h3>
          ...
          <div className="bg-rose-950/40 border border-rose-800/60 rounded-xl p-4">
            ...
            <ul className="space-y-2 text-slate-300">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Instant Liquidation:</strong> A standard 4.8% market wick on 20x leverage results in a 100% loss. Your 50 USDT is gone forever.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-rose-400 font-bold">•</span>
                <span><strong>Funding Rate Bleed:</strong> Holding perpetual futures contracts incurs funding fees every 8 hours, silently depleting your $50 balance.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-rose-400 font-bold">•</span>
